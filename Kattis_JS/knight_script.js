...
function knight_jumps_left(dx_, dy_, first_move) 
{
    ...
    switch(dx.toString() + "," + dy.toString()) {
        case "0,0": return 0; 
        case "1,0": return (first_move) ? 3 : 3;
        case "1,1": return 2;
        case "2,0": return 2;  
        case "2,1": return 1;
...
let size_x, size_y;
let x1, y1, x2, y2;
function tester(x1, y1, x2, y2, size_x, size_y) 
{
    return [solve_algebraic(x1, y1, x2, y2, size_x, size_y), bfs_minmum_jumps(x1, y1, x2, y2, size_x, size_y)];
}
